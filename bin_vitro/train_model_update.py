    ...
    for ttt in range(2):
        ...
        with tf.Graph().as_default():
            ...
            with sv.managed_session(config=config) as session:
                (test_cost, test_pearson, pearson_easy, pearson_difficult, cost_ensemble, pearson_ensemble) = \
                ...
                utils.save_result(train_config,
                                  ...
                                  new_pearson=pearson, new_easy_pearson = pearson_easy, new_difficult_pearson = pearson_difficult, new_cost=cost,
                                  model_dir=traindir)
